...
with st.expander("**Instructions**"):
    ...
    st.write("BoP: Enter the patient's Bleeding on Probing (BoP). You may type the BoP level")
    st.write("PI: Enter the patient's . You may type the PI level")
    st.write("PD: Enter the patient's . You may type the PD level")
    st.write("CAL: Enter the patient's . You may type the CAL level")